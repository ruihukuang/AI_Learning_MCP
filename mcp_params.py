...
def researcher_mcp_server_params(name: str):
    return [
        {"command": "/home/kuangru/.local/bin/uvx", "args": ["mcp-server-fetch"]},
        {
            ...
            "env": {"BRAVE_API_KEY": os.getenv("BRAVE_API_KEY"),"PATH": "/home/kuangru/.nvm/versions/node/v22.18.0/bin:" + os.environ["PATH"]}
        },
        {
            "command": "npx",
            "args": ["-y", "mcp-memory-libsql"],
            "env": {"LIBSQL_URL": f"file:./memory/{name}.db","PATH": "/home/kuangru/.nvm/versions/node/v22.18.0/bin:" + os.environ["PATH"]}
        }
    ]
